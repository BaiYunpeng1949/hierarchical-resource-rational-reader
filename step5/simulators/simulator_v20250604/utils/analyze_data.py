...
if __name__ == "__main__":
    ...
    # file_name = "20251013_1043_trials1_stims9_conds3" # (trained especially)   #"20251013_0901_trials1_stims9_conds3" # (did not train especially)     # full memory agent only.
    # file_name = "20251013_1051_trials1_stims9_conds3"          
    # file_name = "20251013_1650_trials1_stims9_conds3"         # text reading gamma = 0.6                          # Best param
    file_name = "20260605_1539_trials1_stims9_conds3"
