...
class LLMLongTermMemory:
    def __init__(
        ...
        """
        Author: Bai Yunpeng
        Original version: step5/modules/llm_envs/LLMMemories.py
...
class LLMShortTermMemory:
    ...
    def __init__(   # TODO add two things to each sentences: 1. the latest visiting index, 2. the number of visitings
        ...
        if self.use_aalto_openai_api:
            ...
            # # LLM related variables
            # self._client = OpenAI(api_key=openai_api_key)
            raise ValueError("Aalto Key does not work, please contact Prof. Antti for a new API key")
...
class LLMWorkingMemory:
    def __init__(
        ...
        """
        Updated on 2025-09-04
        NOTE: this was mainly used for the LLM-based text comprehension tests and dynamical appraisal calculations. I will re-use our comprehension test module later.
