...
def collect_word_statistics(input_dir):
    """Collect statistics for each unique word occurrence across all simulated trials"""
    # input_dir = "/home/baiy4/reader-agent-zuco/results/section2/_raw_simulated_results"     # TODO make this an input argument
    input_dir = input_dir
...
def analyze_folder(input_folder_dir: str=None):
    # Set up directories
    # output_dir = "/home/baiy4/reader-agent-zuco/results/section2/_simulation_effects_analysis"
    output_dir = input_folder_dir
    plots_dir = output_dir
    # os.makedirs(plots_dir, exist_ok=True)
    
    # Collect word statistics
    print("Collecting word statistics...")
    df = collect_word_statistics(input_dir=input_folder_dir)
