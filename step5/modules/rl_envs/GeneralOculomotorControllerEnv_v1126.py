...
class GeneralOculomotorControllerEnv(Env):
    ...
    def __init__(
        ...
        This version v1126 is derived from v1122, it is for better OMC performance with a tunable number of fixation.
        """
        ...
        print(
            f"{cons.LV_TWO_DASHES}General Oculomotor Controller Environment V1126 -- Deploying the environment in the {self._config['rl']['mode']} mode.")
