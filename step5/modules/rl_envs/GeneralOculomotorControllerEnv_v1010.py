...
class GeneralOculomotorControllerEnv(Env):
    ...
    def __init__(
        ...
        This version v1010 is for better OMC performance without affecting normal simulation processes.
        """
        ...
        print(
            f"{cons.LV_TWO_DASHES}General Oculomotor Controller Environment V1010 -- Deploying the environment in the {self._config['rl']['mode']} mode.")
